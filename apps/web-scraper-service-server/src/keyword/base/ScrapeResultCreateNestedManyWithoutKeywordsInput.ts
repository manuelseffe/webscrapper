...
@InputType()
class ScrapeResultCreateNestedManyWithoutKeywordsInput {
...
export { ScrapeResultCreateNestedManyWithoutKeywordsInput as ScrapeResultCreateNestedManyWithoutKeywordsInput };
